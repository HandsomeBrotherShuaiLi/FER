...
def train_model():
  fer2013 = input_data('S:/pycharm/emotion_analysis/fer2013/fer2013.csv')
...
def predict(image=[[0.1] * 2304]):
  ...
  with tf.Session() as sess:
    ...
    ckpt = tf.train.get_checkpoint_state('S:/pycharm/emotion_analysis/models')
